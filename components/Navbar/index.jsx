        ...
        <>
          ...
          <div className="relative z-50 flex lg:hidden h-[72px] bg-gray1 w-full items-center justify-between border-b border-gray2">
            ...
            <Disclosure.Button className="inline-flex h-6 w-6 mr-10 items-center justify-center text-white">
                {open ? (
                  <FontAwesomeIcon icon={faTimes} className = 'text-white text-opacity-50 hover:text-opacity-100 whitespace-nowrap py-7 px-1ext-sm font-bold'/>
                ) : (
                <FontAwesomeIcon icon={faBars} className = 'text-white text-opacity-50 hover:text-opacity-100 whitespace-nowrap py-7 px-1ext-sm font-bold' />
                  )}
            </Disclosure.Button>
          </div>
